CREATE TABLE volcano_tourism (
    ...
    access_difficulty     VARCHAR(20)     CHECK (access_difficulty IN ('easy', 'moderate', 'hard', 'expert')),
    ...
    current_alert_level   VARCHAR(20)     CHECK (current_alert_level IN ('green', 'yellow', 'orange', 'red')),
...
CREATE INDEX idx_volcano_tourism_difficulty      ON volcano_tourism (access_difficulty);
